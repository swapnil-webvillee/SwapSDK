...
Pod::Spec.new do |s|
  ...
  s.description  = "The TestSwapSDk is a completely customizable widget that can be used in any iOS app. It also plays a little victory fanfare.user will get news of worldwide"

  s.homepage     = "http://webvillee.com"
  ...
  s.source       = { :git => "https://github.com/swapnil-webvillee/SwapSDK.git", :tag => "1.0.0" }
